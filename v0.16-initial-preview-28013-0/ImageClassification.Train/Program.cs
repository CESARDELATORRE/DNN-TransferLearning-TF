...
namespace ImageClassification.Train
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            // Pipeline config from: 0.01f increases accuracy
            // https://github.com/dotnet/machinelearning-samples/blob/47a4f86222d779fd855a88dab2f8408624973707/samples/csharp/getting-started/DeepLearning_TensorFlow_TransferLearning/ImageClassification.Train/Program.cs
